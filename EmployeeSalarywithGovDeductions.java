...
public class EmployeeSalarywithGovDeductions {
    ...
    public static void main(String[] args) {
        // Array of Employee objects to store employee data
        Employee[] employees = {
                new Employee("10001", "Manuel Garcia", "1983-10-11", 535.71, 1125.00, 100.00, 1350.00, 17060.40),
        ...
        // Prompt the user to enter the employee number to retrieve their data
